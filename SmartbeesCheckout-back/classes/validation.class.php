...
class Validation
{
    ...
    public static function validateNation($nation){
        // Nation validation ------------------
        if (empty($nation)) {
    ...
    public static function validatePostcode($postcode){
        ...
        // Ensure postcode is between 2 and 12 characters long
    ...
    public static function validateAltAddress($alt_delivery,$alt_address,$alt_postcode,$alt_city){
    ...
    public static function validateDeliverytype($delivery_type){
    ...
    public static function validatePaymenttype($payment_type,$delivery_type){
    ...
    public static function validateChecks($newsletter,$law){
